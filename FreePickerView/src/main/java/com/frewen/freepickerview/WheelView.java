...
import com.frewen.freepickerview.listener.WheelViewGestureListener;
...
public class WheelView extends View {
    ...
    public final void scrollBy(float velocityY) {
        ...
        mFuture = mExecutor.scheduleWithFixedDelay(new InertialTimerTask(this, velocityY), 0, VELOCITYFLING, TimeUnit.MILLISECONDS);
    }
    ...
    public final void setOnItemSelectedListener(ItemSelectedListener OnItemSelectedListener) {

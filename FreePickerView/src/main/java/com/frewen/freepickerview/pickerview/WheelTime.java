...
import com.frewen.freepickerview.adapter.NumericWheelAdapter;
...
public class WheelTime {
    ...
    public void setPicker(int year, int month, int day, int h, int m) {
        ...
        // 添加"年"监听
        ItemSelectedListener wheelListener_year = new ItemSelectedListener() {
            @Override
        ...
        // 添加"月"监听
        ItemSelectedListener wheelListener_month = new ItemSelectedListener() {
            @Override
            public void onItemSelected(int index) {

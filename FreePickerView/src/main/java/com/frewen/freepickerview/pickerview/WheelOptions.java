...
public class WheelOptions<T> {
    ...
    private ItemSelectedListener wheelListener_option1;
    private ItemSelectedListener wheelListener_option2;
    ...
    public void setPicker(ArrayList<T> options1Items,
        ...
        // 联动监听器
        wheelListener_option1 = new ItemSelectedListener() {
        ...
        wheelListener_option2 = new ItemSelectedListener() {

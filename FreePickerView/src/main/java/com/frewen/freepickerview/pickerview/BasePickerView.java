...
import com.frewen.freepickerview.listener.OnDismissListener;
import com.frewen.freepickerview.utils.AnimUtils;
...
public class BasePickerView {
    ...
    protected void initViews(){
        ...
        rootView = (ViewGroup) layoutInflater.inflate(R.layout.layout_pickerview_base, decorView, false);
        rootView.setLayoutParams(new FrameLayout.LayoutParams(
                ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT
        ));
        mContentContainer = (ViewGroup) rootView.findViewById(R.id.content_container);
                ...
                decorView.post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (onDismissListener != null) {
                            onDismissListener.onPickerViewDismiss(BasePickerView.this);
                        }
                    }
                });
            }
